...
**Runtime:** N/A  
**Memory:** N/A  
**Submitted:** 2026-09-23T03:10:00.657Z  
...
void plusMinus(vector<int> arr) {
    ...
    double res_positive= (double)postitive/n;
    cout<<fixed<<setprecision(6);
    cout<<res_positive<<endl;
    
    double res_negative= (double)negative/n;
    cout<<fixed<<setprecision(6);
    cout<<res_negative<<endl;
    
    double res_zero= (double)zero/n;
    cout<<fixed<<setprecision(6);
    cout<<res_zero<<endl;
